...
export default class BattleScene extends SceneBase {
  ...
  * - false: Show hints for moves
  ...
  addPlayerPokemon(species: PokemonSpecies, level: integer, abilityIndex: integer, formIndex: integer, gender?: Gender, shiny?: boolean, variant?: Variant, ivs?: integer[], nature?: Nature, dataSource?: Pokemon | PokemonData, postProcess?: (playerPokemon: PlayerPokemon) => void, initialPartyIndex?: number): PlayerPokemon {
    const pokemon = new PlayerPokemon(this, species, level, abilityIndex, formIndex, gender, shiny, variant, ivs, nature, dataSource, initialPartyIndex);
    if (postProcess) {
      postProcess(pokemon);
    }
    pokemon.init();
